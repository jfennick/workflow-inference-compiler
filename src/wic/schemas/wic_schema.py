...
def cwl_schema(name: str, cwl: Json, id_prefix: str) -> Json:
    ...
    """
    if cwl['class'] == 'cwltool:ProcessGenerator':
        # TODO: Use a more restricted schema
        schema = named_empty_schema(name)
    ...
    enums = list(cwl['outputs'].keys())
    if enums:
        outputs_keys = {'type': 'string', 'enum': enums}
    else:
        # cwltool:ProcessGenerator has outputs: {}
        outputs_keys = {'type': 'string'}
